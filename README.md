...
- `POST /api/waitlist/preferences` reenvoie le contact pour enrichir les attributs `FIRSTNAME`, `LASTNAME`, `GENDER_PIECES`, `CATEGORIES`, `FAVOURITE_DESIGNERS`
...
- si tu veux enrichir les contacts avec les preferences, verifier dans Brevo les attributs `FIRSTNAME`, `LASTNAME`, `GENDER_PIECES`, `CATEGORIES`, `FAVOURITE_DESIGNERS`
