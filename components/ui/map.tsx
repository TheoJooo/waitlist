  ...
  return (
    ...
    >
      ...
      <svg
        ref={svgRef}
        viewBox="0 0 800 400"
        className={`absolute inset-0 h-full w-full select-none ${interactive ? "pointer-events-auto" : "pointer-events-none"}`}
            ...
            <g key={`points-group-${i}`}>
              <g key={`start-${i}`}>
                <motion.g
                  ...
                  onHoverEnd={interactive ? () => setHoveredLocation(null) : undefined}
