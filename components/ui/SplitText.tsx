...
export default function SplitText({
  ...
  return (
    <Tag
      ref={ref}
      style={{ textAlign: textAlign as CSSProperties['textAlign'], overflow: 'hidden', display: 'inline-block', whiteSpace: 'normal', wordWrap: 'break-word', willChange: 'transform, opacity' }}
