...
const BREVO_ATTRIBUTE_MAPPINGS = [
  ['name', 'NAME'],
  ['gender', 'GENDER'],
  ['categories', 'CATEGORIES'],
  ['favouriteDesigners', 'FAVOURITE_DESIGNERS'],
];
...
function normalizeWaitlistContact(contact) {
  ...
  return {
    ...
    categories: sanitizeText(contact.categories),
...
function buildBrevoAttributes(contact) {
  return Object.fromEntries(
    BREVO_ATTRIBUTE_MAPPINGS.map(([sourceKey, targetKey]) => [targetKey, contact[sourceKey]])
